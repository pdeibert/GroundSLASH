from typing import Set, Tuple, List, Iterable, TYPE_CHECKING
...
def rewrite_aggregate(literal: "AggregateLiteral", aggr_counter: int, glob_vars: Set["Variable"], body_literals: Iterable["Literal"]) -> Tuple["AlphaLiteral", "EpsRule", List["EtaRule"]]:
